...
function BlockDetails() {
  ...
  return (
    <div className="min-h-screen bg-[#000033]">
      {/* Header */}
      <div className="bg-[#000033] text-white px-4 py-4">
      ...
      {/* Content */}
      <div className="bg-white min-h-screen px-5 py-6">
        {/* Block's Analytics */}
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          <h2 className="text-[24px] font-bold text-[#1A1A1A] mb-4">Block's Analytics</h2>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <div className="flex -space-x-2">
                <img src="/nvidia-logo.png" alt="NVIDIA" className="w-8 h-8 rounded-full bg-white p-1 shadow-sm" />
                <img src="/walmart-logo.png" alt="Walmart" className="w-8 h-8 rounded-full bg-white p-1 shadow-sm" />
                <img src="/mastercard-logo.png" alt="Mastercard" className="w-8 h-8 rounded-full bg-white p-1 shadow-sm" />
              </div>
            </div>
            <div className="flex justify-between items-center">
          ...
          <button className="w-full mt-6 py-3 border border-[#0066FF] text-[#0066FF] rounded-xl hover:bg-[#0066FF] hover:text-white transition-colors duration-200">
            View Details
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          <h2 className="text-[24px] font-bold text-[#1A1A1A] mb-6">Block's Activity</h2>
          <div className="space-y-4">
            <div className="flex justify-between items-center">
