...
function VehicleDetails() {
  ...
  return (
    <div className="min-h-screen bg-[#000033]">
      {/* Header */}
      <div className="bg-[#000033] text-white px-4 py-6">
      ...
      <div className="bg-white rounded-t-[32px] min-h-screen shadow-2xl animate-slide-up">
        <div className="p-6">
          ...
          {/* Movement Track - Added shadow and hover effect */}
          <div className="mb-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <h2 className="text-lg font-bold mb-4 text-[#1A1A1A]">Movement Track</h2>
            <div className="bg-[#F5F5F5] rounded-2xl p-4 hover:shadow-lg transition-all duration-300">
          ...
          {/* Transaction Details - Added fade in */}
          <div className="mb-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <h2 className="text-lg font-bold mb-4 text-[#1A1A1A]">Transaction Details</h2>
          ...
          {/* Movement History - Added hover effects and staggered animation */}
          <div className="animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <h2 className="text-lg font-bold mb-4 text-[#1A1A1A]">Movement History</h2>
            <div className="space-y-4">
              {[
