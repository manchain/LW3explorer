            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead>
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Fee Recipient</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {transactions.map((transaction, index) => (
                  <tr key={index}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{transaction.feeRecipient}</td>
